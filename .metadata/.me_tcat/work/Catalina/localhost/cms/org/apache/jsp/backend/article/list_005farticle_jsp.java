...
public final class list_005farticle_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/backend/";
      ...
      out.write("\t\t\twindow.document.getElementById(\"f\").action=\"ArticleServlet?m=delBatch\";\r\n");
      out.write("\t\t\twindow.document.getElementById(\"f\").submit();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction publishBatch(){\r\n");
      out.write("\t\t\tif(confirm(\"确定发布吗？\")){\r\n");
      out.write("\t\t\twindow.document.getElementById(\"f\").action=\"ArticleServlet?m=publishBatch\";\r\n");
      out.write("\t\t\twindow.document.getElementById(\"f\").submit();\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction pageSize(ps){\r\n");
      out.write("\t\t\twindow.location.href=\"ArticleServlet?m=list&pageSize=\"+ps+\"&pageNo=\"+1;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t\tfunction pageNode(ps){\r\n");
      out.write("\t\t\twindow.location.href=\"ArticleServlet?m=list&pageNo=\"+ps;\r\n");
      out.write("\t\t}\r\n");
      out.write("\t</script>\r\n");
      out.write("</head>\r\n");
      out.write("<body>\r\n");
      ...
      out.write("             &nbsp;&nbsp;<img src=\"images/edit.gif\" width=\"10\" height=\"10\" /> <a href=\"javascript:publishBatch()\">发布</a>\r\n");
...
List<Article> articles=(List<Article>)request.getAttribute("articles");
      ...
      out.write("          <input type=\"checkbox\" name=\"ids\" id=\"ids\" value=\"");
      out.print(article.getId() );
      out.write("\" />\r\n");
      out.write("        </div></td>\r\n");
      out.write("        <td height=\"20\" bgcolor=\"#FFFFFF\" class=\"STYLE19\"><div align=\"center\"><a href=\"ArticleServlet?m=show&id=");
      out.print(article.getId() );
      ...
      out.write("</div></td>\r\n");
      out.write("        <td height=\"20\" bgcolor=\"#FFFFFF\" class=\"STYLE19\"><div align=\"center\">");
      out.print(article.getClick_score() );
      out.write("</div></td>\r\n");
      out.write("        <td height=\"20\" bgcolor=\"#FFFFFF\" class=\"STYLE19\"><div align=\"center\">");
      out.print(article.getMsg_count() );
      out.write("</div></td>\r\n");
      out.write("        <td height=\"20\" bgcolor=\"#FFFFFF\" class=\"STYLE19\"><div align=\"center\">");
      out.print(article.getCreate_time() );
      out.write("</div></td>\r\n");
      out.write("        <td height=\"20\" bgcolor=\"#FFFFFF\" class=\"STYLE19\"><div align=\"center\">");
      out.print(article.getUpdate_time() );
      out.write("</div></td>\r\n");
      out.write("        <td height=\"20\" bgcolor=\"#FFFFFF\" class=\"STYLE19\"><div align=\"center\">");
      out.print(article.getPublish_time() );
      out.write("</div></td>\r\n");
      out.write("        <td height=\"20\" bgcolor=\"#FFFFFF\"><div align=\"center\" class=\"STYLE21\">\r\n");
      out.write("        <a href=\"ArticleServlet?m=publish&id=");
      out.print(article.getId() );
      out.write("\" title=\"点击发布文章\">发布</a> | \r\n");
      out.write("        <a href=\"ArticleServlet?m=del&id=");
      out.print(article.getId() );
      out.write("\" title=\"点击删除文章\">删除</a> |\r\n");
      out.write("        <a href=\"ArticleServlet?m=mod&id=");
      out.print(article.getId() );
...
PageModel pm=(PageModel)request.getAttribute("pm");
      ...
      out.write("\t\t\t\t<a href=\"ArticleServlet?m=list&pageNo=1\">首页</a>\r\n");
      out.write("\t\t\t\t<a href=\"ArticleServlet?m=list&pageNo=");
      out.print((pm.getPageNo()-1)<1?1:(pm.getPageNo()-1));
      out.write("\">上页</a>\r\n");
      out.write("\t\t\t\t<font color=\"red\">\r\n");
      out.write("\t\t\t\t<select name=\"pageNode\" onchange=\"pageNode(this.value)\"  >\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t");
for(int i=1;i<pm.getTotalPage()+1;i++){
      ...
      out.write('"');
      out.write(' ');
      out.print((pm.getPageNo()==i?"selected":""));
      out.write("\r\n");
      out.write("\t\t\t\t>");
      out.print(i );
      out.write("</option>\r\n");
      ...
      out.write("\t\t\t\t</font>\r\n");
      out.write("\t\t\t\t<a href=\"ArticleServlet?m=list&pageNo=");
      out.print(pm.getPageNo()+1>pm.getTotalPage()?pm.getTotalPage():(pm.getPageNo()+1));
      out.write("\">下页</a>\r\n");
      out.write("\t\t\t\t<a href=\"ArticleServlet?m=list&pageNo=");
      out.print(pm.getTotalPage());
      out.write("\">尾页</a>\r\n");
...
for(int i=5;i<=25;i+=5){ 
      ...
      out.print(i );
      out.write(' ');
      out.print((pm.getPageSize()==i?"selected":""));
      out.write("\r\n");
      out.write("\t>");
      out.print(i );
      out.write("</option>\r\n");
