...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/backend/";
      ...
      out.write("\t\t<h3>请修改文章</h3>\r\n");
      out.write("\t\t");
Article article=(Article)request.getAttribute("article");
      out.write("\r\n");
      out.write("   \t\t<form action=\"ArticleServlet?m=modify&id=");
      ...
      out.write("\" size=\"60\" maxlength=\"20\" /> \r\n");
      out.write("\t\t\t\t<br/>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div>\r\n");
      ...
      out.write("\" size=\"60\" maxlength=\"50\" /> \r\n");
      out.write("\t\t\t\t<br/>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div>\r\n");
...
List<Channel> channels=(List<Channel>)request.getAttribute("channels"); 
      ...
      out.write('"');
      out.write(' ');
      out.print((article.getChannel().getId().equals(channel.getId()))?"selected":"");
      out.write("\r\n");
      out.write("\t\t\t\t\t>");
      ...
      out.write("\t\t\t\t<input type=\"checkbox\" name=\"recommend\" value=\"1\" ");
      out.print((article.isIs_recommend()?"checked='checked'":""));
      out.write(">是否推荐\r\n");
      out.write("\t\t\t\t<input type=\"checkbox\" name=\"headerline\" value=\"1\" ");
      out.print((article.isIs_header_line()?"checked='checked'":""));
      out.write(">是否头条\r\n");
      out.write("\t\t\t\t<br/>\r\n");
      out.write("\t\t\t</div>\r\n");
      out.write("\t\t\t<div>\r\n");
      out.write("\t\t\t\t<label for=\"content\">内容:</label>\r\n");
      out.write("\t\t\t\t<textarea rows=\"10\" cols=\"100\" name=\"content\" id=\"content\">");
